!function (t, e) {
    ...
    return function (t) {
        ...
        function h() {
            ...
            void 0 !== document.hidden ? (s = "hidden", a = "visibilitychange") : void 0 !== document.msHidden ? (s = "msHidden", a = "msvisibilitychange") : void 0 !== document.webkitHidden && (s = "webkitHidden", a = "webkitvisibilitychange"), u(document, a, t), u(window, "blur", e), u(window, "focus", n)
        }
        ...
        function f(t) {
            t.options.modal && (0 === S && p(), e.DocModalCount = S += 1)
        }

        function h(t) {
            if (t.options.modal && S > 0 && (e.DocModalCount = S -= 1, S <= 0)) {
        ...
        function m(t) {
            ...
            t.layoutDom = document.querySelector("div#" + e), t.layoutDom || (t.layoutDom = document.createElement("div"), t.layoutDom.setAttribute("id", e), k.addClass(t.layoutDom, "noty_layout"), document.querySelector("body").appendChild(t.layoutDom))
        }
        ...
        var _ = n(0), k = function (t) {
                ...
                if (null != t)for (var n in t)Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
                return e.default = t, e
            }(_), S = (e.PageHidden = !1, e.DocModalCount = 0), C = {originalTitle: null, count: 0, changed: !1, timer: -1},
            D = e.docTitle = {
                increment: function () {
                    C.count++, D._update()
                }, decrement: function () {
                    if (--C.count <= 0)return void D._clear();
                    D._update()
                }, _update: function () {
         ...
         */
            !function (e, n) {
                ...
                function b(t, e) {
                    e._state === nt ? k(t, e._result) : e._state === ot ? S(t, e._result) : C(e, void 0, function (e) {
                        return g(t, e)
                    }, function (e) {
                        return S(t, e)
                    })
                ...
                function w(t, e, n) {
                    e.constructor === t.constructor && n === l && e.constructor.resolve === d ? b(t, e) : n === it ? (S(t, it.error), it.error = null) : void 0 === n ? k(t, e) : i(n) ? y(t, e, n) : k(t, e)
                }

                function g(e, n) {
                    e === n ? S(e, h()) : t(n) ? w(e, n, m(n)) : k(e, n)
                }
                ...
                function P(t, e, n, o) {
                    ...
                    if (r) {
                        if (s = E(n, o), s === rt ? (c = !0, u = s.error, s.error = null) : a = !0, e === s)return void S(e, p())
                    } else s = o, a = !0;
                    e._state !== et || (r && a ? g(e, s) : c ? S(e, u) : t === nt ? k(e, s) : t === ot && S(e, s))
                }
                ...
                function M(t, e) {
                    this._instanceConstructor = t, this.promise = new t(f), this.promise[tt] || A(this.promise), I(e) ? (this._input = e, this.length = e.length, this._remaining = e.length, this._result = new Array(this.length), 0 === this.length ? k(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(), 0 === this._remaining && k(this.promise, this._result))) : S(this.promise, q())
                }
                ...
                function V(t) {
                    this[tt] = O(), this._result = this._state = void 0, this._subscribers = [], f !== t && ("function" != typeof t && L(), this instanceof V ? T(this, t) : W())
                }
                ...
                return M.prototype._enumerate = function () {
                    ...
                    var o = this.promise;
                    o._state === et && (this._remaining--, t === ot ? S(o, n) : this._result[e] = n), 0 === this._remaining && k(o, this._result)
                ...
                }, V.all = j, V.race = N, V.resolve = d, V.reject = H, V._setScheduler = r, V._setAsap = s, V._asap = U, V.prototype = {
                    constructor: V,
                    then: l,
                    catch: function (t) {
        ...
        var s = n(4), u = function (t) {
            ...
            return r(t, [{
                ...
                key: "show", value: function () {
                    var e = this;
                    if (!0 !== this.options.killer || d.PageHidden)if ("string" != typeof this.options.killer || d.PageHidden) {
                        var n = d.getQueueCounts(this.options.queue);
                        if (n.current >= n.maxVisible || d.PageHidden)return d.addToQueue(this), d.PageHidden && this.hasSound && c.inArray("docHidden", this.options.sounds.conditions) && c.createAudioElements(this), d.PageHidden && c.inArray("docHidden", this.options.titleCount.conditions) && d.docTitle.increment(), this
                    } else t.closeAll(this.options.killer); else t.closeAll();
                    ...
                    if (d.build(this), d.handleModal(this), this.options.force ? this.layoutDom.insertBefore(this.barDom, this.layoutDom.firstChild) : this.layoutDom.appendChild(this.barDom), this.hasSound && !this.soundPlayed && c.inArray("docVisible", this.options.sounds.conditions) && c.createAudioElements(this), c.inArray("docVisible", this.options.titleCount.conditions) && d.docTitle.increment(), this.shown = !0, this.closed = !1, d.hasButtons(this) && Object.keys(this.options.buttons).forEach(function (t) {
                            ...
                            d.fire(e, "onHover")
                        }, !1), this.options.timeout && c.addClass(this.barDom, "noty_has_timeout"), c.inArray("button", this.options.closeWith)) {
